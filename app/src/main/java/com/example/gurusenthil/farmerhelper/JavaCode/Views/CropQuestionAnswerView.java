...
public class CropQuestionAnswerView extends QuestionAnswerModelView {
    ...
    public CropQuestionAnswerView(Context context, TextToSpeech textToSpeech){
        super(context);
    ...
    public CropQuestionAnswerView(Context context, AttributeSet attrs){
        super(context, attrs);
        this.context = context;
        inflateView();
    }

    public CropQuestionAnswerView(Context context, AttributeSet attrs, int defStyle){
    ...
    private void inflateView() {
        ...
        layoutInflater.inflate(R.layout.crop_persistent_view_layout, getAnswerView(), true);
